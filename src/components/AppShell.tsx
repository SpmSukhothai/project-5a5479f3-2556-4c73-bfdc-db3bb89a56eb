...
import { LayoutDashboard, School, Users, Baby, BookOpen, FileBarChart, Settings, LogOut, Menu } from "lucide-react";
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      <aside className={cn(
        "no-print fixed inset-y-0 left-0 z-40 w-72 bg-sidebar text-sidebar-foreground transition-transform lg:static lg:translate-x-0",
        ...
        <div className="absolute inset-x-0 bottom-0 border-t border-sidebar-border p-4 text-xs">
